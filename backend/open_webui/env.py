...
LITE_NATIVE_PROTOCOL_ADAPTERS_ENABLED = (
    os.getenv('LITE_NATIVE_PROTOCOL_ADAPTERS_ENABLED', 'False').lower() == 'true'
)
...
LITE_OFFICE_FILE_CONTEXT_MAX_BYTES = int(os.getenv('LITE_OFFICE_FILE_CONTEXT_MAX_BYTES', str(2 * 1024 * 1024)))
LITE_DOCX_FILE_CONTEXT_MAX_BYTES = int(
    os.getenv('LITE_DOCX_FILE_CONTEXT_MAX_BYTES', _LITE_OFFICE_FILE_CONTEXT_MAX_BYTES_ENV or str(4 * 1024 * 1024))
)
LITE_XLSX_FILE_CONTEXT_MAX_BYTES = int(
    os.getenv('LITE_XLSX_FILE_CONTEXT_MAX_BYTES', _LITE_OFFICE_FILE_CONTEXT_MAX_BYTES_ENV or str(4 * 1024 * 1024))
)
LITE_PPTX_FILE_CONTEXT_MAX_BYTES = int(
    os.getenv('LITE_PPTX_FILE_CONTEXT_MAX_BYTES', _LITE_OFFICE_FILE_CONTEXT_MAX_BYTES_ENV or str(15 * 1024 * 1024))
)
LITE_OFFICE_FILE_CONTEXT_MAX_CHARS = int(os.getenv('LITE_OFFICE_FILE_CONTEXT_MAX_CHARS', str(128 * 1024)))
LITE_OFFICE_SPREADSHEET_MAX_SHEETS = int(os.getenv('LITE_OFFICE_SPREADSHEET_MAX_SHEETS', '5'))
LITE_OFFICE_SPREADSHEET_MAX_ROWS = int(os.getenv('LITE_OFFICE_SPREADSHEET_MAX_ROWS', '500'))
LITE_PDF_FILE_CONTEXT_MAX_BYTES = int(os.getenv('LITE_PDF_FILE_CONTEXT_MAX_BYTES', str(4 * 1024 * 1024)))
LITE_PDF_FILE_CONTEXT_MAX_CHARS = int(os.getenv('LITE_PDF_FILE_CONTEXT_MAX_CHARS', str(128 * 1024)))
LITE_PDF_MAX_PAGES = int(os.getenv('LITE_PDF_MAX_PAGES', '20'))
LITE_GO_FILE_EXTRACTOR_ENABLED = os.getenv('LITE_GO_FILE_EXTRACTOR_ENABLED', 'True').lower() == 'true'
LITE_GO_FILE_EXTRACTOR_PATH = os.getenv('LITE_GO_FILE_EXTRACTOR_PATH', '/app/bin/file-extractor')
LITE_GO_FILE_EXTRACTOR_TIMEOUT_SECONDS = int(os.getenv('LITE_GO_FILE_EXTRACTOR_TIMEOUT_SECONDS', '20'))
LITE_GO_FILE_EXTRACTOR_FALLBACK = os.getenv('LITE_GO_FILE_EXTRACTOR_FALLBACK', 'False').lower() == 'true'
LITE_GO_S3_ENABLED = os.getenv('LITE_GO_S3_ENABLED', 'True').lower() == 'true'
LITE_GO_S3_TIMEOUT_SECONDS = int(os.getenv('LITE_GO_S3_TIMEOUT_SECONDS', '60'))
LITE_GO_S3_FALLBACK = os.getenv('LITE_GO_S3_FALLBACK', 'False').lower() == 'true'
