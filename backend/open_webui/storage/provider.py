...
def _load_azure_dependencies():
    from azure.core.exceptions import ResourceNotFoundError
    from azure.identity import DefaultAzureCredential
    from azure.storage.blob import BlobServiceClient

    return ResourceNotFoundError, DefaultAzureCredential, BlobServiceClient
...
class S3StorageProvider(StorageProvider):
    def __init__(self):
        boto3, Config, _ = _load_s3_dependencies()
        config = Config(
            s3={
    ...
    def upload_file(self, file: BinaryIO, filename: str, tags: Dict[str, str]) -> Tuple[bytes, str]:
        ...
        _, _, ClientError = _load_s3_dependencies()
...
class GCSStorageProvider(StorageProvider):
    def __init__(self):
        storage, _, _ = _load_gcs_dependencies()
    ...
    def upload_file(self, file: BinaryIO, filename: str, tags: Dict[str, str]) -> Tuple[bytes, str]:
        ...
        _, GoogleCloudError, _ = _load_gcs_dependencies()
        contents, file_path = LocalStorageProvider.upload_file(file, filename, tags)
        try:
    ...
    def get_file(self, file_path: str) -> str:
        ...
        _, _, NotFound = _load_gcs_dependencies()
        try:
...
class AzureStorageProvider(StorageProvider):
    def __init__(self):
        _, DefaultAzureCredential, BlobServiceClient = _load_azure_dependencies()
    ...
    def get_file(self, file_path: str) -> str:
        ...
        ResourceNotFoundError, _, _ = _load_azure_dependencies()
        try:
